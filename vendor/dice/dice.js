...
const DICE = (function() {
    ...
    var vars = { //todo: make these configurable on init
        ...
        // GW4E theme: irradiated-green dice with bright hazard-amber
        // numerals, on the same near-black desk color as the app's
        // roll-log/stage panels. Low shininess + dark specular + dimmer
        // spotlight so the pale original palette's glare/blowout is gone -
        // a saturated face color also survives the overhead spotlight much
        // better than a near-white one did.
        material_options: {
            specular: 0x0a0a0a,
            color: 0xffffff, //neutral so dice_color below renders true
            shininess: 12,
            shading: THREE.FlatShading,
        },
        label_color: '#ffcf40', //numbers on dice
        dice_color: '#4f7a33',
        ambient_light_color: 0xf0f0f0,
        spot_light_color: 0xefefef,
        desk_color: '#14130f', //canvas background
        desk_opacity: 0.55,
        use_shadows: true,
    ...
    that.dice_box.prototype.reinit = function(container) {
        ...
        // GW4E: /5 instead of /8 - noticeably larger dice for our small stage.
        ...
        this.light = new THREE.SpotLight(vars.spot_light_color, 1.2); //GW4E: was 2.0, blowing out pale dice faces
    ...
    //GW4E: sound asset not vendored (no audio feature yet) - no-op for now.
