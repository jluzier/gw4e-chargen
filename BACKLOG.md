...
- **Step 7 — Cryptic Alliance.** Stubbed/skipped: full alliance write-ups aren't in the extracted JSON yet. Needs that data before this can be more than a placeholder.
